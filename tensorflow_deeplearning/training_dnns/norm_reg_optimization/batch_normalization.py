"""
Batch Normalization for parameter regularization
"""
...
# And batch normalziation at each layer
reset_graph()
...
# Extra upadte oprations for batch normalization
...
with tf.Session() as sess:
    ...
    save_path = saver.save(sess, "./bn_model_final.ckpt")

# Display Graph
tfg.board(tf.get_default_graph()).view()

# Display the variables in the graph
